...
ActiveRecord::Schema.define(version: 20180803105812) do
  ...
  create_table "attendances", force: :cascade do |t|
    ...
    t.index ["classday_id"], name: "index_attendances_on_classday_id"
  end
  ...
  create_table "classdays", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["batch_id"], name: "index_classdays_on_batch_id"
  end
